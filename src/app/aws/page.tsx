...
const resources: Resource[] = [
  // Introducción a AWS
  {
    title: 'AWS Free Tier',
    description:
      'Explora y prueba los servicios de AWS de forma gratuita, con acceso a más de 60 productos',
    icon: Cloud,
  ...
  },
  {
    ...
    description:
      'Videos introductorios sobre los servicios principales de AWS con ejemplos prácticos',
    icon: Book,
  ...
  },
  {
    ...
    description:
      'Curso fundamental para introducirte a los conceptos de AWS Cloud',
    icon: Video,
  ...
  // Entrenamiento y cursos
  {
    title: 'AWS Academy',
    description:
      'Currículo de computación en la nube para instituciones de educación superior con laboratorios prácticos',
    icon: GraduationCap,
  ...
  },
  {
    title: 'AWS Educate',
    description:
      'Recursos de aprendizaje en la nube para estudiantes y educadores con créditos gratuitos',
    icon: GraduationCap,
  ...
  },
  {
    ...
    description:
      'Entrenamiento digital personalizado y preparación para certificaciones con seguimiento de progreso',
    icon: GraduationCap,
  ...
  },
  {
    title: 'A Cloud Guru',
    description:
      'Plataforma de aprendizaje con cursos, laboratorios y aprendizaje práctico',
    icon: Cloud,
  ...
  // Certificaciones
  {
    ...
    description:
      'Certificación fundamental para fluidez en la nube con contenido actualizado para 2025',
    icon: Award,
  ...
  },
  {
    ...
    description:
      'Certificación para diseñar y desplegar sistemas escalables en AWS con prácticas recomendadas',
    icon: Award,
  ...
  },
  {
    ...
    description:
      'Certificación para desarrollo en AWS enfocada en servicios y herramientas de programación',
    icon: Award,
  ...
  },
  {
    ...
    description:
      'Certificación avanzada para arquitectos de soluciones con experiencia',
    icon: Award,
  ...
  // Rutas de aprendizaje
  {
    ...
    description:
      'Guía paso a paso para principiantes con recursos recomendados y calendario de estudios',
    icon: Compass,
  ...
  },
  {
    ...
    description:
      'De principiante a arquitecto de soluciones con estudios de caso y ejemplos prácticos',
    icon: Compass,
  ...
  // Recursos por nivel
  {
    ...
    description:
      'Colección de talleres y laboratorios prácticos autoguiados con entornos sandbox',
    icon: Terminal,
  ...
  },
  {
    title: 'AWS Qwiklabs',
    description:
      'Laboratorios prácticos para ganar experiencia con entornos reales y guiados',
    icon: Wrench,
  ...
  },
  {
    ...
    description:
      'Guías para diseñar arquitecturas seguras y eficientes con pilares fundamentales',
    icon: FileText,
  ...
  },
  {
    ...
    description:
      'Patrones de arquitectura, diagramas de referencia y mejores prácticas',
    icon: Cpu,
  ...
  // Exam Preparation
  {
    ...
    description:
      'Recursos oficiales para la preparación de exámenes incluyendo guías de estudio y ejemplos',
    icon: FileText,
  ...
  },
  {
    ...
    description:
      'Exámenes de práctica oficiales para certificaciones con preguntas similares a las del examen real',
    icon: CheckSquare,
    link: 'https://aws.amazon.com/certification/exam-prep/',
    category: 'Exam Preparation',
    level: 'Intermediate',
  ...
  },
  {
    ...
    description:
      'Exámenes de práctica y laboratorios con explicaciones detalladas',
    icon: CheckSquare,
  ...
  // Community and Support
  {
    title: 'AWS Forums',
    description:
      'Foros comunitarios para usuarios de AWS donde puedes hacer preguntas y compartir conocimientos',
    icon: Users,
  ...
  },
  {
    title: 'AWS Blogs',
    description:
      'Blogs oficiales de AWS con actualizaciones y mejores prácticas escritos por expertos de AWS',
    icon: BookOpen,
  ...
  },
  {
    ...
    description:
      'Preguntas frecuentes y guías de resolución de problemas organizadas por servicio',
    icon: HelpCircle,
  ...
  },
  {
    ...
    description:
      'Reconocimiento a expertos comunitarios que comparten conocimientos sobre AWS',
    icon: Star,
  ...
  },
  {
    title: 'AWS re:Post',
    description:
      'Comunidad de preguntas y respuestas técnicas verificadas sobre AWS',
    icon: HelpCircle,
  ...
  // Hands-on Labs
  {
    ...
    description:
      'Tutoriales paso a paso para aprender a utilizar los servicios de AWS',
    icon: Terminal,
  ...
  },
  {
    title: 'AWS Cloud9',
    description:
      'Entorno de desarrollo basado en la nube para escribir, ejecutar y depurar código',
    icon: Code,
  ...
  // Security
  {
    ...
    description:
      'Centro para ver y gestionar alertas de seguridad y evaluaciones de cumplimiento',
    icon: ShieldCheck,
...
const categories: Category[] = [
  {
    name: 'All',
    icon: Cloud,
    description: 'Todos los recursos de AWS en un solo lugar',
  },
  {
    name: 'Introduction to AWS',
    icon: Book,
    description: 'Conceptos fundamentales para iniciar con AWS',
  },
  {
    name: 'Training and Courses',
    icon: GraduationCap,
    description: 'Cursos estructurados para todos los niveles',
  },
  {
    name: 'Certifications',
    icon: Award,
    description: 'Certificaciones AWS reconocidas en la industria',
  },
  {
    name: 'Learning Paths',
    icon: Compass,
    description: 'Rutas de progresión según objetivos profesionales',
  },
  {
    name: 'Resources by Level',
    icon: Star,
    description: 'Material adaptado a tu nivel de experiencia',
  },
  {
    name: 'Exam Preparation',
    icon: FileText,
    description: 'Recursos para aprobar exámenes de certificación',
  },
  {
    name: 'Community and Support',
    icon: Users,
    description: 'Comunidad y soporte para usuarios de AWS',
  },
  {
    name: 'Hands-on Labs',
    icon: Terminal,
    description: 'Ejercicios prácticos para experiencia real',
  },
  {
    name: 'Architecture',
    icon: Cpu,
    description: 'Mejores prácticas de diseño para soluciones AWS',
  },
  {
    name: 'Security',
    icon: ShieldCheck,
    description: 'Protección y seguridad para entornos AWS',
  },
]
...
function ExamVoucherPromotion() {
  const currentContent = {
    steps: [
      'Registrarse en AWS Educate (es gratis)',
      "Completar un curso con insignia (el más rápido es 'Introduction to Generative AI')",
      'Esperar la validación y unirse a ETC (puede tardar entre 5 minutos y 1 día)',
      'Acumular puntos en ETC completando actividades semanales. El primer día se pueden ganar hasta 2000 puntos con todas las actividades disponibles',
      'Conseguir 4500 puntos para vouchers Foundational y 5200 para Associate',
      'Realizar un curso de preparación de AWS Skill Builder para la certificación deseada',
      'Completar una prueba de práctica con al menos 70% de acierto',
      'Solicitar el voucher una vez cumplidos todos los requisitos',
    ],
    tips: [
      'Los puntos se gastan al canjear el voucher, hacerlo solo cuando estés listo para el examen',
      'En una semana es posible conseguir aproximadamente 500 puntos',
      'Crear una cuenta con el mismo correo que se usa en AWS Educate',
    ],
  }

  return (
    <motion.div
      className="mb-8 bg-gradient-to-b from-blue-700 to-blue-950 text-white rounded-xl shadow-lg overflow-hidden"
    ...
    >
      <div className="p-6 sm:p-8">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold">
              ¡Voucher GRATIS para el examen de certificación AWS!
            </h2>
            <p className="text-blue-200 mt-1">
              Descuento del 100% a través de AWS Educate y Emerging Talent
              Community
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center mb-4 text-sm text-blue-100">
          ...
          <span>Válido hasta el 31 de agosto de 2025</span>
        </div>
          ...
          <div className="space-y-3 pl-2">
            {currentContent.steps.map((step: string, index: number) => (
              <div key={index} className="flex items-start">
                <div className="flex items-center justify-center h-6 w-6 rounded-full bg-blue-600 text-white text-xs font-bold mr-3 mt-0.5 flex-shrink-0">
                  {index + 1}
                </div>
                <p>{step}</p>
              </div>
        ...
        <div className="mb-6 bg-blue-600/20 p-4 rounded-lg">
          <h3 className="text-lg font-semibold mb-3 flex items-center">
        ...
        <div className="text-center">
          <Link
            href="https://aws.amazon.com/es/education/awseducate/"
            passHref
            legacyBehavior
          >
            <motion.a
...
export default function AWSHub() {
  ...
  const resourceStats = useMemo(() => {
    return {
      ...
      byLevel: {
        beginner: filteredResources.filter((r) => r.level === 'Beginner')
          .length,
        intermediate: filteredResources.filter(
          (r) => r.level === 'Intermediate',
        ).length,
        advanced: filteredResources.filter((r) => r.level === 'Advanced')
          .length,
      },
      byType: {
        courses: filteredResources.filter((r) => r.type === 'Course').length,
        documentation: filteredResources.filter(
  ...
  return (
    <main className="flex-grow flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
      ...
      >
        <p>
          Última actualización: Marzo 2025 • Los recursos presentados pueden
          cambiar sin previo aviso
        </p>
        <p className="mt-1">
          Esta página es solo informativa y no está afiliada oficialmente con
          Amazon Web Services
        </p>
      </motion.div>
    </main>
...
function CategoryFilter({
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4">Recursos disponibles</h2>
...
function ResourceDashboard({ stats }: { stats: ResourceStats }) {
  return (
    <motion.div
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byLevel.beginner / stats.total) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byLevel.intermediate / stats.total) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byLevel.advanced / stats.total) * 100}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byType.courses / stats.total) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byType.documentation / stats.total) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(stats.byType.videos / stats.total) * 100}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                className="bg-green-500 h-2 rounded-full"
                style={{
                  width: `${(stats.byPricing.free / stats.total) * 100}%`,
                }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
              <div
                className="bg-blue-500 h-2 rounded-full"
                style={{
                  width: `${(stats.byPricing.paid / stats.total) * 100}%`,
                }}
              ></div>
            </div>
          </div>
...
function FeaturedRecommendations({ resources }: { resources: Resource[] }) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4">Recomendaciones destacadas</h2>
        ...
        {featuredResources.map((resource, index) => (
          ...
          >
            ...
            <div className="relative h-full p-6 flex flex-col justify-end z-20">
              ...
              <Link href={resource.link} passHref legacyBehavior>
                <motion.a
                  className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 text-sm font-medium rounded-md shadow-sm text-blue-700 bg-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Explorar
...
function LearningPathways() {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4">Rutas de apredizaje</h2>
